...
Market Sense AI es una herramienda de analisis predictivo  de ventas para productos digitales usando IA como base para hacer las proyecciones de ventas.
...
Ingresar la Api Key de Groq en la cabecera (arriba a la derecha)
Completar el formulario
hacer click en (PREDECIR CON GROQ AI)