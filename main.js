...
async function runGroq(){
  ...
  if(!apiKey){
    showErr('Pega tu API Key de Groq arriba o usa el <strong>Modo Demo</strong>. Gratis en <a href="https://console.groq.com/keys" target="_blank">console.groq.com/keys</a>');
    return;
  }
